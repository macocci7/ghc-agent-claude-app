...
class ModelBaseTest extends TestCase
{
    ...
    public function test_constructor_initializes_database_connection()
    {
        // Test the actual constructor by creating a concrete implementation
        $testModel = new class extends ModelBase {
            protected string $table = 'test_table';
        ...
        // The constructor should have initialized the database connection
        $this->assertInstanceOf(PDO::class, $testModel->getDb());
    }
